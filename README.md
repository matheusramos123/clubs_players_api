...
A simple API to manage **players** and **clubs** using **FastAPI**, **SQLAlchemy (ORM)**, and **MySQL (async)**.  
Perfect for learning database relationships and API development in Python.
